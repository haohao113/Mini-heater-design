...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _mode=R5
	.DEF _temp_value=R6
	.DEF _temp_value_msb=R7
	.DEF _temp_min=R8
	.DEF _temp_min_msb=R9
	.DEF _temp_max=R10
	.DEF _temp_max_msb=R11
	.DEF _temp_int=R12
	.DEF _temp_int_msb=R13
	.DEF __lcd_x=R4
...
_0x8:
	.DB  0xCB,0x48,0x84,0x3A
_0x9:
	.DB  0xD6,0x64,0x79,0x39
_0xA:
	.DB  0x6C,0xCF,0x58,0x34
_0x0:
	.DB  0x4D,0x61,0x6E,0x75,0x61,0x6C,0x0,0x54
	.DB  0x65,0x6D,0x70,0x3A,0x20,0x25,0x64,0xDF
	.DB  0x43,0x0,0x41,0x75,0x74,0x6F,0x0,0x54
	.DB  0x3A,0x20,0x25,0x64,0xDF,0x43,0x0,0x4D
	.DB  0x3A,0x20,0x25,0x64,0xDF,0x43,0x0,0x53
	.DB  0x65,0x74,0x74,0x69,0x6E,0x67,0x0,0x54
	.DB  0x68,0x72,0x65,0x73,0x68,0x6F,0x6C,0x64
	.DB  0x3A,0x20,0x25,0x64,0xDF,0x43,0x0
_0x2000003:
	.DB  0x80,0xC0
_0x2060060:
	.DB  0x1
...
__GLOBAL_INI_TBL:
	...
	.DW  0x01
	.DW  _auto_temperature_threshold
	.DW  _0x3*2
...
; 0000 009F               auto_temperature_threshold);
	LDI  R30,LOW(_buffer_temp)
	LDI  R31,HIGH(_buffer_temp)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,31
	CALL SUBOPT_0x6
...
; 0000 00A4       if (temp_int > auto_temperature_threshold)
	LDS  R30,_auto_temperature_threshold
	LDS  R31,_auto_temperature_threshold+1
	CP   R30,R12
	CPC  R31,R13
	BRGE _0x1F
; 0000 00A5       {
...
; 0000 00C0         auto_temperature_threshold++;
	LDI  R26,LOW(_auto_temperature_threshold)
	LDI  R27,HIGH(_auto_temperature_threshold)
	CALL SUBOPT_0x8
...
SUBOPT_0x5:
	...
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
	LDI  R26,LOW(_buffer_temp)
	LDI  R27,HIGH(_buffer_temp)
	JMP  _lcd_puts
